...
Patch0: cryptsetup_1.6.4_NUKE_keys.patch 
...
disk encryption using dm-crypt kernel module. Added 
...
Requires: fipscheck-lib%{_isa} >= 1.3.0
# Need support for empty password in gcrypt PBKDF2 and fixed gcrypt PBKDF2
%if 0%{?fedora} >= 21 || 0%{?rhel} >= 7
...
%patch0 -p1 -b .cryptsetup_1.6.4_NUKE_keys
...
%changelog
* Sun Mar 22 2015 sid <siddharths@fedoraproject.org> - 1.6.4-2.nuke
- Added cryptsetup NUKE Keys Feature like in Offsec Kali Linux
- Thanks Mati Aharoni (muts) and Juergen Pabel
